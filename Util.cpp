...
namespace Util {
	...
	namespace Color {
		...
		*/  
		...
		COLORREF PRIMARY_BASE = HexToRGB("AA3939");
		COLORREF PRIMARY_3 = HexToRGB("801515");
		COLORREF PRIMARY_4 = HexToRGB("550000");
		// purple
		COLORREF SECONDARY_1 = HexToRGB("9775AA");
		COLORREF SECONDARY_2 = HexToRGB("764B8E");
		COLORREF SECONDARY_BASE = HexToRGB("582A72");
		COLORREF SECONDARY_3 = HexToRGB("3D1255");
		COLORREF SECONDARY_4 = HexToRGB("260339");
		// blue
		COLORREF TERTIARY_1 = HexToRGB("669999");
		COLORREF TERTIARY_2 = HexToRGB("407F7F");
		COLORREF TERTIARY_BASE = HexToRGB("226666");
		COLORREF TERTIARY_3 = HexToRGB("0D4D4D");
		COLORREF TERTIARY_4 = HexToRGB("003333");
		// green
		COLORREF COMPLEMENTARY_1 = HexToRGB("88CC88");
		COLORREF COMPLEMENTARY_2 = HexToRGB("55AA55");
		COLORREF COMPLEMENTARY_BASE = HexToRGB("2D882D");
		COLORREF COMPLEMENTARY_3 = HexToRGB("116611");
		COLORREF COMPLEMENTARY_4 = HexToRGB("004400");
